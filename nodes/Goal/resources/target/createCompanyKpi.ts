...
export const description: INodeProperties[] = [
	{
		...
		type: 'string',
		required: true,
		displayOptions: { show: { resource: ['target'], operation: ['createCompanyKpi'] } },
		default: '',
	...
	},
	{
		...
		default: {},
		displayOptions: { show: { resource: ['goal'], operation: ['createCompanyKpi'] } },
...
export async function execute(this: IExecuteFunctions, index: number): Promise<INodeExecutionData[]> {
	...
	const response = await goalApiRequest.call(this, 'POST', '/target/create/kpi.company', body);
